...
//     useEffect(()=>{setEmployees(employeeStore.getAllEmployees());
//        const updateUI = () => {setEmployees([...employeeStore.getAllEmployees])}; 
//        employeeStore.on("change",updateUI);
//        return() =>{employeeStore.removeListener("change",updateUI)};
//     },[]);
//   return (
//     <div>
//       <h2> Employee List</h2>
...
function EmployeeList() {
  ...
  return (
    <div>
      ...
      <button onClick={() => addEmployee("Niti,Dhana")}>
        Add Employee
      </button>
